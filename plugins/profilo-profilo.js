...
await conn.sendMessage(m.chat,{text:'*𝐒𝐄𝐋𝐄𝐙𝐈𝐎𝐍𝐀 𝐔𝐍’𝐎𝐏𝐙𝐈𝐎𝐍𝐄:*',footer:'> *THE PUNISHER-BOT*',buttons:[{buttonId:'.wallet',buttonText:{displayText:'💰 Portafoglio'},type:1},{buttonId:'.posizione',buttonText:{displayText:'🏆 Posizione'},type:1}],headerType:1},{quoted:m})
}
